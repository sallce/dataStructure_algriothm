package com.dataStructure_algriothm.queue;
...
public class PriorityQueueExample
{
    public static void main(String args[]){
        ...
        //Creating priority queue with comparator
        PriorityQueue<Integer> pQueueInt = new PriorityQueue<Integer>(
        ...
        // Adding item to pQueueInt
        pQueueInt.add(1);
        pQueueInt.add(10);
        pQueueInt.add(5);
        pQueueInt.add(20);

        Iterator<Integer> itrInt = pQueueInt.iterator();
